        ...
        init: function () {
            ...
            form.validate({
                ...
                rules: {
                    ...
                    'button[0][campaign_button_label]': {
                        required: true
                    },
                    /*'button[1][campaign_button_label]': {
                        required: true
                    },*/
                    campaign_deal_start: {
                        required: true
                ...
                submitHandler: function (form) {
                    ...
                    if(campaigns == 0){
                        ...
                        var $loader = $('#loader');
                        var $button = $("#campaign-button-submit"),
                        $userdata = $('#submit_form').serialize(),
                        $method = $("#campaign-button-submit").attr('data-method'),
                        ...
                        $.ajax({
                            ...
                            success: function(resp){
                                ...
                                sweetAlert('Thank You! You have successfully added the campaign :)');
